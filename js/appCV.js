...
app.config(['$locationProvider','$routeProvider','$translateProvider',
	function($locationProvider,$routeProvider,$translateProvider){
		...
		$translateProvider.translations('bg', {
			...
			SKILLS: 'Умения',
			POSITION: 'Длъжност',
			POSITION_DESCRIPTION0: 'Разработчик на уеб апликации и поддръжка на Комуникационните Услуги',
			...
			PLACE_DESCRIPTION1: 'Разработка на хибридно приложения за мобилни устройства ориентирано към сектора на фризьорски салони. Технологиите използване за разботката са: Ionic, AngularJS, PHP и MySQL',
			PLACE_DESCRIPTION2: 'Aire Networks',
