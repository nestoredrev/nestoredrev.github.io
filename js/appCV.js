...
app.config(['$locationProvider','$routeProvider','$translateProvider',
	function($locationProvider,$routeProvider,$translateProvider){
		...
		$translateProvider.translations('es', {
			...
			ABOUT_ME_DESCRIPTION: `Me llamo Nestor. Soy de Bulgaria y vivo en España desde 2002. Me gradue en la Universidad Miguel Hernéndez de Elche en Grado en Ingenería Informática en tecnologías de la Información. Mi pasión es el desarrollo web con las tecnologias Angular, Ionic y Nodejs.`,
			POSITION: 'Puesto',
			...
			PERIOD: 'Periodo',
			PERIOD_DESCRIPTION0: 'Julio 2021 - Febrero 2024',
			...
			CERF_DESCRIPTION0: 'Información sobre el curso y el código realizado en los siguientes enlances:',
			CERF_DESCRIPTION1: 'Información sobre el curso y el código realizado en los siguientes enlances:',
			CERF_DESCRIPTION2: 'Información sobre el curso y el código realizado en los siguientes enlances:',
			CERF_DESCRIPTION3: 'Información sobre el curso y el código realizado en los siguientes enlances:',
			CERF_DESCRIPTION4: 'Información sobre el curso y el código realizado en los siguientes enlances:',
			TITLE: 'Título',
		...
		$translateProvider.translations('en', {
			...
			SKILLS: 'Skills',
			ABOUT_ME: 'About me',
			ABOUT_ME_DESCRIPTION: `My is name is Nestor. I am from Bulgaria but I live in Spain since 2002. I have a degree in Computer
			Engineering and Information Technologies (2017) in the Miguel Hernández University. My passion is the web
			development with tecnologies like Angular, Ionic and Nodejs.`,
			POSITION: 'Position',
			...
			PERIOD: 'Period',
			PERIOD_DESCRIPTION0: 'July 2021 - February 2024',
			...
			CERF_DESCRIPTION0: 'Information about the course and the code made in the following links:',
			CERF_DESCRIPTION1: 'Information about the course and the code made in the following links:',
			CERF_DESCRIPTION2: 'Information about the course and the code made in the following links:',
			CERF_DESCRIPTION3: 'Information about the course and the code made in the following links:',
			CERF_DESCRIPTION4: 'Information about the course and the code made in the following links:',
			TITLE: 'Qualification',
		...
		$translateProvider.translations('bg', {
			...
			SKILLS: 'Умения',
			ABOUT_ME: 'За мен',
			ABOUT_ME_DESCRIPTION: 'Казвам се Нестор. Аз съм от България и живея в Испания от 2002 г. Завършил съм университета Мигел Ернендес в Елче със степен по компютърно инженерство в информационните технологии. Моята страст е уеб разработката с технологии Angular, Ionic и Nodejs.',
			POSITION: 'Длъжност',
			...
			PERIOD: 'Период',
			PERIOD_DESCRIPTION0: 'Юли 2021 - Февруари 2024',
			...
			CERF_DESCRIPTION0: 'Информация за курса и кода направени в следните линкове:',
			CERF_DESCRIPTION1: 'Информация за курса и кода направени в следните линкове:',
			CERF_DESCRIPTION2: 'Информация за курса и кода направени в следните линкове:',
			CERF_DESCRIPTION3: 'Информация за курса и кода направени в следните линкове:',
			CERF_DESCRIPTION4: 'Информация за курса и кода направени в следните линкове:',
			TITLE: 'Диплома',
